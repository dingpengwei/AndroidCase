 ...
 */
public class DownloadMulti extends DownloadButtonProgressBar {

    public DownloadMulti(Context context) {
        super(context);
    }

    public DownloadMulti(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public DownloadMulti(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    class DownloadTask extends AsyncTask<String,Integer,OnButtonProgressListener> {
        ...
        private DownloadMulti singleDownload;
        private OnButtonProgressListener onButtonProgressListener;

        public DownloadTask(String remoteFilePath,String localFilePath,DownloadMulti singleDownload,OnButtonProgressListener buttonProgressListener) {
            super();
